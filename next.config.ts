        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://*.vercel-scripts.com https://chatling.ai https://*.chatling.ai https://cdn.jsdelivr.net https://www.clarity.ms https://connect.facebook.net https://payments.kashier.io",
              ...
              "connect-src 'self' https://*.vercel-scripts.com https://vercel.live https://chatling.ai https://*.chatling.ai https://www.clarity.ms https://connect.facebook.net https://payments.kashier.io",
