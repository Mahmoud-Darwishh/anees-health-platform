export const MEDPLUM_CODE_SYSTEMS = {
  ...
  outcomeMeasure: 'https://anees.health/fhir/CodeSystem/outcome-measure',
  assessmentInstrument: 'https://anees.health/fhir/CodeSystem/assessment-instrument',
  assessmentRisk: 'https://anees.health/fhir/CodeSystem/assessment-risk',
  aneesObservationCategory: 'https://anees.health/fhir/CodeSystem/observation-category',
