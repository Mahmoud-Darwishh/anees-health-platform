...
import type { LabOrderSummary, LabResultSummary, LabResultValueSummary } from '@/lib/medplum/labs';
import type { EpisodeSummary } from '@/lib/medplum/episodes';
...
export type AdminPatientDetailData = {
  ...
  labResultObservations: LabResultValueSummary[];
  labResultObservationsError: string | null;
