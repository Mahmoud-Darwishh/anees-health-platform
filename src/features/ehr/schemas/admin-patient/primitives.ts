...
export function formDataToInput(formData: FormData): Record<string, FormDataEntryValue | null> {
  return {
    ...
    glucoseTiming: formData.get('glucoseTiming'),
    glucoseMeal: formData.get('glucoseMeal'),
    glucoseUnit: formData.get('glucoseUnit'),
    glucoseValue: formData.get('glucoseValue'),
    glucoseSymptomatic: formData.get('glucoseSymptomatic'),
    glucoseTreatment: formData.get('glucoseTreatment'),
    glucoseNote: formData.get('glucoseNote'),
